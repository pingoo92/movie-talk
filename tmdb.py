...
baseurl = "https://api.themoviedb.org/3/search/movie?api_key=8b5308de95e8d355d9f3281bd409def4&language=fr&query=" + sMovie
...
idurl = "https://api.themoviedb.org/3/movie/" + str(movieID) + "?api_key=8b5308de95e8d355d9f3281bd409def4&language=fr"
result = urlopen(idurl).read()
data = json.loads(result)


creditsurl = "https://api.themoviedb.org/3/movie/" + str(movieID) + "/credits?api_key=8b5308de95e8d355d9f3281bd409def4&language=fr"
